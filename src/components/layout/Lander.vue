<template>
    ...
    xl:bg-green-100">
            ...
            lg:h-full lg:items-center lg:pt-0">
                ...
                <div class="" v-if="lander_title">
                    ...
                    <div class="text-center lg:text-left mt-8">
                        <h2 class="text-2xl text-gray-600 md:text-3xl xl:text-4xl">
                            {{lander_subtitle}}
                        </h2>
                    </div>
                </div>
        ...
        <!-- <div class="w-full pb-10 absolute bottom-0">
            <div class="flex justify-center">
                <svg version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve" width="51" height="51">
